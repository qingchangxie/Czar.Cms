...
string con = "Data Source=127.0.0.1,2633; User ID = sa; Password = 123321; Initial Catalog = Czar.Cms; Pooling = true; Max Pool Size=100; ";
...
void test_select_content_with_comment()
{
    using (var conn = new SqlConnection(con))
    {
